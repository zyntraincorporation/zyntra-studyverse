...
async function getUserWords(userId, { search, sort, filter, skip, take }) {
...
async function updateWord(userId, id, data) {
  return prisma.vocabularyWord.update({ where: { id, userId }, data });
}
...
module.exports = { getUserWords, createWord, updateWord, deleteWord, getWordById };